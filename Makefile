...
.PHONY: all process_raw_spark process_raw_customs prepare_tariffs construct_instrument

all: process_raw_spark process_raw_customs prepare_tariffs construct_instrument
